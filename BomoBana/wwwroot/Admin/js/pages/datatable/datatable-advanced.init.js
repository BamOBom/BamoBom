...
$('#file_export').DataTable({
    ...
    initComplete: function () {
        ...
        $('.buttons-copy span').html("کپی");
        $('.buttons-csv span').html("خروجی csv");
        $('.buttons-print span').html("پرینت");
        $('.buttons-pdf span').html("خروجی pdf");
        $('.buttons-excel span').html("خروجی excel");
...
$('#lang_file').DataTable({
    "language": {
        "url": "dist/js/pages/datatable/Iran.json"
    }
});
